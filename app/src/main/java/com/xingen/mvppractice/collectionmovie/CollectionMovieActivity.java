...
public class CollectionMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CollectionMovieConstract.Presenter presenter=new CollectionMoviePresenter(fragment,getSupportLoaderManager(),new LoaderProvider(BaseApplication.getAppContext()));
    }
}
